...
{
    const char* pszTimestamp = "JDCOIN Genesis Block: 2020/12/14 12:42:00";
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1608751075, 0, 0x1e0ffff0, 1, 250 * COIN);
        ...
        vSeeds.push_back(CDNSSeedData("3.133.230.144", "3.133.230.144", true));     // Primary DNS Seeder from Fuzzbawls
