...
public:
    ...
    void doZPivRescan(const CBlockIndex* pindex, const CBlock& block, std::set<uint256>& setAddedToWallet, const Consensus::Params& consensus, bool fCheckZJDC);
    ...
    std::unique_ptr<CzJDCTracker> zpivTracker{nullptr};
